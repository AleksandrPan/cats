class Card {
    ...
    getElement() {
        ...
        const cardTitle = this.element.querySelector('.card_name');
        const cardImage = this.element.querySelector('.card_image');
        const cardLike = this.element.querySelector('.card_like');
